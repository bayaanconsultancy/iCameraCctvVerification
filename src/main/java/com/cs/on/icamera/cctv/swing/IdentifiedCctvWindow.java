    ...
    private JButton getGetDetailsButton(int discoveredCount, GridBagConstraints gbc) {
        ...
        getDetailsButton.addActionListener(e -> {
            ...
            new Thread(() -> {
                ...
                if (DataStore.getUnauthorizedCctvCount() > 0) SwingUtilities.invokeLater(UsernamePasswordWindow::new);
                else SwingUtilities.invokeLater(DownloadTemplateWindow::new);
            }).start();
        });
