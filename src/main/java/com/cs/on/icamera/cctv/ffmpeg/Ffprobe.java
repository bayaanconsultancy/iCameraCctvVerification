...
public class Ffprobe {
	...
	public static void get() throws IOException {
		...
		for (FFmpegStream stream : streams) {
			logger.info(
					"encoding: {}, resolutionWidth: {}, resolutionHeight: {}, quality: {}, frameRate: {}, encodingInterval/is_avc: {}, bitrate: {}",
					stream.codec_name, stream.width, stream.height, stream.bits_per_sample, stream.avg_frame_rate,
					stream.is_avc, stream.bit_rate);
		}
